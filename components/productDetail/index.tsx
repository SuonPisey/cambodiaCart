            ...
            <div className="grid gap-6">
              <div className="flex gap-4">
                ...
                <div className="grid gap-2">
                  ...
                  <p className="text-sm leading-loose text-muted-foreground">
                    I ve been wearing this t-shirt for a few weeks now and it s
                    quickly become one of my favorites. The fabric is soft and
                    breathable, and the prism design is really eye-catching.
                    Highly recommend!
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div className="grid gap-2">
                  ...
                  <p className="text-sm leading-loose text-muted-foreground">
                    I was a bit hesitant about the prism design at first, but it
                    s grown on me. The t-shirt is super comfortable and the
                    quality is great. I d definitely buy another one.
                  </p>
                </div>
              </div>
            </div>
